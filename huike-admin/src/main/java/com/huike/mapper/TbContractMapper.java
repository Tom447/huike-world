...
public interface TbContractMapper {
     ...
     * 统计指定时间内的合同数量
     */
    public int countAllContracts(@Param("beginCreateTime") String beginCreateTime, @Param("endCreateTime") String endCreateTime);
    ...
    double sumAllSalesStatistics(@Param("beginCreateTime") String beginCreateTime, @Param("endCreateTime") String endCreateTime);

    List<ContractCountDTO> countByEveryDay(LocalDateTime beginTime, LocalDateTime endTime);

    List<ContractMoneyDTO> sumMoneyByEveryDay(LocalDateTime beginTime, LocalDateTime endTime);
}
