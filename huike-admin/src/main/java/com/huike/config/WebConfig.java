...
import com.huike.interceptor.LoginCheckInterceptor;
...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        //添加登录校验的拦截器  -- 放行: login , 验证码 , logout , swagger静态资源
        registry.addInterceptor(loginCheckInterceptor).addPathPatterns("/**").excludePathPatterns("/captchaImage", "/login", "/logout", "/druid/**", "/common/download**" ,
                "/favicon.ico", "/error", "/doc.html", "/webjars/**","/img/**","/swagger-resources/**", "/v2/api-docs");
    }
